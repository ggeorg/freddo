...
package javaxx.jmdns.impl.tasks.state;
...
import javaxx.jmdns.impl.DNSOutgoing;
import javaxx.jmdns.impl.DNSStatefulObject;
import javaxx.jmdns.impl.JmDNSImpl;
import javaxx.jmdns.impl.ServiceInfoImpl;
import javaxx.jmdns.impl.constants.DNSConstants;
import javaxx.jmdns.impl.constants.DNSState;
import javaxx.jmdns.impl.tasks.DNSTask;

/**
 * This is the root class for all state tasks. These tasks work with objects that implements the {@link javaxx.jmdns.impl.DNSStatefulObject} interface and therefore participate in the state machine.
 * 
