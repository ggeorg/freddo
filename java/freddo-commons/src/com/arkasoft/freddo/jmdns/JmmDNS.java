 ...
 *
 */
package com.arkasoft.freddo.jmdns;
...
import com.arkasoft.freddo.jmdns.impl.JmmDNSImpl;
...
public interface JmmDNS extends Closeable {
     ...
     * @see com.arkasoft.freddo.jmdns.JmDNS#getName()
     */
     ...
     * @see com.arkasoft.freddo.jmdns.JmDNS#getHostName()
     */
     ...
     * @see com.arkasoft.freddo.jmdns.JmDNS#getInterface()
     */
     ...
     * @see com.arkasoft.freddo.jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String)
     */
     ...
     * @return list of service info. If no service info is found the list is empty.
     * @see com.arkasoft.freddo.jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String, long)
     */
     ...
     * @return list of service info. If no service info is found the list is empty.
     * @see com.arkasoft.freddo.jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String, boolean)
     */
     ...
     *            if <code>true</code> ServiceListener.resolveService will be called whenever new new information is received.
     * @return list of service info. If no service info is found the list is empty.
     * @see com.arkasoft.freddo.jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String, boolean, long)
     */
     ...
     * @param name
     *            unqualified service name, such as <code>foobar</code> .
     * @see com.arkasoft.freddo.jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String)
     */
     ...
     * @param persistent
     *            if <code>true</code> ServiceListener.resolveService will be called whenever new new information is received.
     * @see com.arkasoft.freddo.jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String, boolean)
     */
     ...
     * @see com.arkasoft.freddo.jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String, long)
     */
     ...
     * @param timeout
     *            timeout in milliseconds
     * @see com.arkasoft.freddo.jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String, boolean, long)
     */
     ...
     * @exception IOException
     * @see com.arkasoft.freddo.jmdns.JmDNS#addServiceTypeListener(com.arkasoft.freddo.jmdns.ServiceTypeListener)
     */
     ...
     * @param listener
     *            listener for service types
     * @see com.arkasoft.freddo.jmdns.JmDNS#removeServiceTypeListener(com.arkasoft.freddo.jmdns.ServiceTypeListener)
     */
     ...
     * @see com.arkasoft.freddo.jmdns.JmDNS#addServiceListener(java.lang.String, com.arkasoft.freddo.jmdns.ServiceListener)
     */
     ...
     * @param listener
     *            listener for service updates
     * @see com.arkasoft.freddo.jmdns.JmDNS#removeServiceListener(java.lang.String, com.arkasoft.freddo.jmdns.ServiceListener)
     */
     ...
     * @exception IOException
     * @see com.arkasoft.freddo.jmdns.JmDNS#registerService(com.arkasoft.freddo.jmdns.ServiceInfo)
     */
     ...
     * @see com.arkasoft.freddo.jmdns.JmDNS#unregisterService(com.arkasoft.freddo.jmdns.ServiceInfo)
     */
     ...
     *
     * @see com.arkasoft.freddo.jmdns.JmDNS#unregisterAllServices()
     */
     ...
     * @param type
     *            full qualified service type, such as <code>_http._tcp.local.</code>.
     * @see com.arkasoft.freddo.jmdns.JmDNS#registerServiceType(java.lang.String)
     */
     ...
     * @see com.arkasoft.freddo.jmdns.JmDNS#list(java.lang.String)
     */
     ...
     * @return An array of service instance.
     * @see com.arkasoft.freddo.jmdns.JmDNS#list(java.lang.String, long)
     */
     ...
     * @see com.arkasoft.freddo.jmdns.JmDNS#listBySubtype(java.lang.String)
     */
     ...
     *            timeout in milliseconds. Typical timeout should be 6s.
     * @return A dictionary of service info by subtypes.
     * @see com.arkasoft.freddo.jmdns.JmDNS#listBySubtype(java.lang.String, long)
     */
