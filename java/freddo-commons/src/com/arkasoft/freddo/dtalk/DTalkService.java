...
public class DTalkService {
  ...
  public void enableWebPresence(boolean webPresence) {
    ...
    if (webPresence) {
      try {
        ...
        getWebPresenceService().publishService(new URI(webPresenceURI), config.getJmDNS(), localServiceInfo);
      } catch (Exception e) {
        // TODO Auto-generated catch block
        e.printStackTrace();
      }
      ...
      try {
        getWebPresenceService().unpublishService();
      } catch (Exception e) {
        // Ignore
      }
    }
  ...
  public Map<String, ServiceInfo> getServiceInfoMap() {
    return serviceDiscovery.getServiceInfoMap();
  }
