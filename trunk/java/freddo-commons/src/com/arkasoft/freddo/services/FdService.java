...
public abstract class FdService<T> implements MessageBusListener<JSONObject> {
  ...
  private void invoke(String method, JSONObject message) {
    try {
      Method m = getClass().getDeclaredMethod(method, JSONObject.class);
  ...
  protected static void sendResponse(JSONObject request, String value) {
    try {
      JSONObject response = newResponse(request);
      if (response != null) {
        response.put(MessageEvent.KEY_BDOY_RESULT, value);
  ...
  protected static void sendResponse(JSONObject request, JSONObject value) {
    try {
      JSONObject response = newResponse(request);
      if (response != null) {
        response.put(MessageEvent.KEY_BDOY_RESULT, value);
  ...
  protected static void sendResponse(JSONObject request, JSONArray value) {
    try {
      JSONObject response = newResponse(request);
      if (response != null) {
        response.put(MessageEvent.KEY_BDOY_RESULT, value);
  ...
  protected static void sendErrorResponse(JSONObject request, String error) {
    try {
      JSONObject response = newResponse(request);
      if (response != null) {
  ...
  protected void fireEvent(String event, JSONObject value) {
    try {
      JSONObject message = newEvent(event);
  ...
  protected void fireEvent(String event, JSONArray value) {
    try {
      JSONObject message = newEvent(event);
      message.put(MessageEvent.KEY_BODY_PARAMS, value);
      MessageBus.sendMessage(message.optString(MessageEvent.KEY_BODY_SERVICE), message);
  ...
  protected void fireEvent(String event, String value) {
    try {
      JSONObject message = newEvent(event);
      message.put(MessageEvent.KEY_BODY_PARAMS, value);
      MessageBus.sendMessage(message.optString(MessageEvent.KEY_BODY_SERVICE), message);
  ...
  protected void fireEvent(String event, boolean value) {
    try {
      JSONObject message = newEvent(event);
      message.put(MessageEvent.KEY_BODY_PARAMS, value);
      MessageBus.sendMessage(message.optString(MessageEvent.KEY_BODY_SERVICE), message);
  ...
  protected void fireEvent(String event, int value) {
    try {
      JSONObject message = newEvent(event);
      message.put(MessageEvent.KEY_BODY_PARAMS, value);
      MessageBus.sendMessage(message.optString(MessageEvent.KEY_BODY_SERVICE), message);
  ...
  protected void fireEvent(String event, double value) {
    try {
      JSONObject message = newEvent(event);
      message.put(MessageEvent.KEY_BODY_PARAMS, value);
      MessageBus.sendMessage(message.optString(MessageEvent.KEY_BODY_SERVICE), message);
