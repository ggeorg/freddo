...
import javaxx.jmdns.impl.JmmDNSImpl;
...
public interface JmmDNS extends Closeable {
     ...
     * @see javaxx.jmdns.JmDNS#getName()
     */
     ...
     * @see javaxx.jmdns.JmDNS#getHostName()
     */
     ...
     * @see javaxx.jmdns.JmDNS#getInterface()
     */
     ...
     * @see javaxx.jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String)
     */
     ...
     * @return list of service info. If no service info is found the list is empty.
     * @see javaxx.jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String, long)
     */
     ...
     * @return list of service info. If no service info is found the list is empty.
     * @see javaxx.jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String, boolean)
     */
     ...
     *            if <code>true</code> ServiceListener.resolveService will be called whenever new new information is received.
     * @return list of service info. If no service info is found the list is empty.
     * @see javaxx.jmdns.JmDNS#getServiceInfo(java.lang.String, java.lang.String, boolean, long)
     */
     ...
     * @param name
     *            unqualified service name, such as <code>foobar</code> .
     * @see javaxx.jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String)
     */
     ...
     * @param persistent
     *            if <code>true</code> ServiceListener.resolveService will be called whenever new new information is received.
     * @see javaxx.jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String, boolean)
     */
     ...
     * @see javaxx.jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String, long)
     */
     ...
     * @param timeout
     *            timeout in milliseconds
     * @see javaxx.jmdns.JmDNS#requestServiceInfo(java.lang.String, java.lang.String, boolean, long)
     */
     ...
     * @exception IOException
     * @see javaxx.jmdns.JmDNS#addServiceTypeListener(javaxx.jmdns.ServiceTypeListener)
     */
     ...
     * @param listener
     *            listener for service types
     * @see javaxx.jmdns.JmDNS#removeServiceTypeListener(javaxx.jmdns.ServiceTypeListener)
     */
     ...
     * @see javaxx.jmdns.JmDNS#addServiceListener(java.lang.String, javaxx.jmdns.ServiceListener)
     */
     ...
     * @param listener
     *            listener for service updates
     * @see javaxx.jmdns.JmDNS#removeServiceListener(java.lang.String, javaxx.jmdns.ServiceListener)
     */
     ...
     * @exception IOException
     * @see javaxx.jmdns.JmDNS#registerService(javaxx.jmdns.ServiceInfo)
     */
     ...
     * @see javaxx.jmdns.JmDNS#unregisterService(javaxx.jmdns.ServiceInfo)
     */
     ...
     *
     * @see javaxx.jmdns.JmDNS#unregisterAllServices()
     */
     ...
     * @param type
     *            full qualified service type, such as <code>_http._tcp.local.</code>.
     * @see javaxx.jmdns.JmDNS#registerServiceType(java.lang.String)
     */
     ...
     * @see javaxx.jmdns.JmDNS#list(java.lang.String)
     */
     ...
     * @return An array of service instance.
     * @see javaxx.jmdns.JmDNS#list(java.lang.String, long)
     */
     ...
     * @see javaxx.jmdns.JmDNS#listBySubtype(java.lang.String)
     */
     ...
     *            timeout in milliseconds. Typical timeout should be 6s.
     * @return A dictionary of service info by subtypes.
     * @see javaxx.jmdns.JmDNS#listBySubtype(java.lang.String, long)
     */
