...
public class AssetFileRequestHandler implements HttpRequestHandler {
  ...
  public AssetFileRequestHandler(Context service, String root, PackageInfo pInfo) {
  ...
  public void handleHttpRequest(ChannelHandlerContext ctx, FullHttpRequest req, String path) throws Exception {
    ...
    try {
      ...
      DTalkNettyServerHandler.sendHttpResponse(ctx, req,
    ...
    DTalkNettyServerHandler.sendHttpResponse(ctx, req, response);
  }
