...
public class AWTTraiIconTest {
  private static final String TAG = LOG.tag(AWTTraiIconTest.class);
  ...
  public static void main(String[] args) {
    ...
    startup(getServiceConfiguation());
  ...
  private static void createAndShowGUI() {
    ...
    if (!SystemTray.isSupported()) {
      LOG.w(TAG, "SystemTray is not supported");
      return;
    }
  ...
  protected static Image createImage(String path, String description) {
    URL imageURL = AWTTraiIconTest.class.getResource(path);
